...
function calculateTip() {
  ...
  let tt = (document.getElementById("total-tip").innerHTML =
    "" + totalTip.toFixed(2));
  let tp = (document.getElementById("tip-per-person").innerHTML =
    "" + tipPerPerson);
}
...
function createPercentBtns(array) {
  ...
  for (var i = 0; i < array.length; i++) {
    ...
    if (i == 2)
      butn.setAttribute("class", "selected-percentage percentage-button");
    else butn.setAttribute("class", "percentage-button");
